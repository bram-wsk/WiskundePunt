...
export const DEFAULT_AI_GUIDE_CONFIG: AIGuideConfig = {
  ...
  "sections": {
    ...
    "blockingCriteria": "SIGNAALMECHANISME (3x dezelfde foutsoort binnen één oefensessie)\n\nDEFINITIES\n- Oefensessie = één oefenreeks van 5 gelijksoortige oefeningen (of de actieve sessie zoals in de app gedefinieerd).\n- Foutsoort = één van: denkfout, tekenfout, rekenfout, fout tegen de volgorde van bewerkingen.\n\nTRIGGER\n- Het systeem activeert een signaal wanneer een leerling 3 keer (of meer) dezelfde foutsoort maakt binnen één oefensessie.\n- Als een stap meerdere foutsoorten bevat, telt enkel de HOOGST PRIORITAIRE foutsoort mee voor de blokkeringsteller:\n  Prioriteit: volgorde → teken → reken → denk\n  (Zo voorkom je dat één “rommelstap” meteen meerdere tellers tegelijk laat oplopen.)\n\nACTIE VOOR DE LEERLING\n- Zodra de trigger optreedt:\n  1) Er verschijnt  een \"Even Pauze\"-scherm als zachte interventie;\n  2) De leerling krijgt gerichte tips over de foutsoort;\n  3) De leerling kan dit scherm zelf wegklikken om verder te oefenen, ze worden dus niet hard geblokkeerd.\n\nACTIE VOOR DE LEERKRACHT\n- Er wordt een signaal (InterventionAlert) doorgestuurd.\n- Deze waarschuwing verschijnt real-time op het tabblad “Live hulp” van het leerkrachtendashboard.\n- Het verdwijnt zodra de leerkracht het afvinkt of wanneer de leerling zelf lokaal aangeeft verder te oefenen (afhankelijk van instellingen).\n\nBELANGRIJK DIDACTISCH GEDRAG VAN AI\n- Tijdens interventie mag AI een korte, neutrale foutfocus tonen in de modal (max. 1 zin, geen stappenplan).",
